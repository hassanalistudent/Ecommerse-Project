    ...
    <div className="container mx-auto mt-10">
      ...
      <div className="flex justify-around items-center flex-wrap mt-[10rem]">
        <form className="w-[40rem]" onSubmit={submitHandler}>
          ...
          <div className="mb-4">
            <label className="block mb-2">Postel Code</label>
            <input type="text" className="w-full p-2 border rounded" placeholder="Enter Postel Code" 
          ...
          <div className="mb-4">
           ...
           <div className="mb-4">
            <label className="block text-gray-400">
              ...
              // value='Payoneer' checked={paymentMethod ==='Payoneer'} 
              // onChange={(e)=> setPaymentMethod(e.target.value)}
              />
              <span className="ml-2">
                Payoneer or Cradit Card
              </span>
              </label>
            </label>
          </div>
